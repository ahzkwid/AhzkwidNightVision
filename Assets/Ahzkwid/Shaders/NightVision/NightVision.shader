Shader "Ahzkwid/NightVision"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					col.g += max(col_base.r,max(col_base.g,col_base.b)) * _Brightness;
					col.g = min(col.g,1);
		...
		FallBack "Diffuse"
		CustomEditor "NightVisionInspector"
}
//ahzkwid
